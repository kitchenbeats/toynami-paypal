...
def clean_html_text(text):
    """Properly clean and escape HTML text for PostgreSQL"""
...
{after_products}"""
    ...
    print("\n✅ Generated seed.sql with properly escaped HTML")
    print(f"  - {len(BRAND_SLUGS)} brands with UUIDs")
    print(f"  - {len(products)} products with cleaned descriptions")
